...
var firstPerson = 'USER_1'; // Replace with the actual name
var firstLocation = 'Location'; // Replace with the actual location

var secondPerson = 'User_2'; // Replace with the actual name
...
var timeLeaveStamp = new Date(year, month, date);

//first day of renewed contact (year, month, day)
var timeMeetStamp = new Date(year, month, date);
